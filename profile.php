<?php
	...
	$login = new Login();
	$_SESSION['student_userid'] = isset($_SESSION['student_userid']) ? $_SESSION['student_userid'] : 0;
	
	$user_data = $login->check_login($_SESSION['student_userid'],false);
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(isset($_POST['first_name'])){
			...
			$settings_class->save_settings($_POST,$_SESSION['student_userid']);

		}else{

			$post = new Post();
			$id = $_SESSION['student_userid'];
...
<!DOCTYPE html>
	...
	<body style="font-family: tahoma; background-color: #151515;">
		...
		<div style="width: 800px;margin:auto;min-height: 400px;">
			...
			<div style="background-color: white;text-align: center;color: #405d9b">
				...
				<a href="index.php"><div id="menu_buttons" style="color:black">Timeline</div></a>
				<a href="profile.php?section=about&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons" style="color:black;">About</div></a>
				<a href="profile.php?section=followers&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons" style="color:black;">Followers</div></a>
				<a href="profile.php?section=following&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons" style="color:black;">Following</div></a>
				<a href="profile.php?section=photos&id=<?php echo $user_data['userid'] ?>"><div id="menu_buttons" style="color:black;">Photos</div></a>
				
				<?php 
					if($user_data['userid'] == $_SESSION['student_userid']){
