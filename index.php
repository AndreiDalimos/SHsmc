<?php 
	...
	$login = new Login();
	$user_data = $login->check_login($_SESSION['student_userid']);
...
<!DOCTYPE html>
	...
	<body style="font-family: tahoma; background-color: #242424;">
 				...
 				<div style="min-height: 400px;flex:2.5;padding: 20px;padding-right: 0px;">
	 				...
	 				<div id="post_bar">
 						...
 						<?php 
 							...
 							$followers = $user_class->get_following($_SESSION['student_userid'],"user");
 							...
 							if($follower_ids){
 								$myuserid = $_SESSION['student_userid'];
